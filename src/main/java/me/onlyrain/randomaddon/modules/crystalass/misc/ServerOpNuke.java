...
public class ServerOpNuke extends Module {
    ...
    public ServerOpNuke() {
        super(RandomAddon.CATEGORYC, "Server Operator Nuke", "For trolling once you get operator on a server.");
    ...
    public void onActivate() {
        try {
            ...
            MeteorClient.LOG.error("NullPointerException in the onGameJoinEvent, " + NPE);
            toggle();
        }
    }
