...
public class LecternCrash extends Module {
    ...
    public LecternCrash() {
        super(RandomAddon.CATEGORYC, "Lectern Crash", "CRYSTAL || Sends broken packets while using a lectern.");
    ...
    private void onOpenScreenEvent(OpenScreenEvent event) {
        try {
            ...
            MeteorClient.LOG.error("NullPointerException for LecternCrash onOpenScreenEvent: ", NPE);
        }
    }
}
