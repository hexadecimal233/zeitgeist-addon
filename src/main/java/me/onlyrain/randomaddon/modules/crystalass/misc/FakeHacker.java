...
public class FakeHacker extends Module {
    ...
    public FakeHacker() {
        super(RandomAddon.CATEGORYC, "Fake Hacker", "Makes it seem like another player is hacking.");
    }

    public void onActivate() {
        if (Modules.get().isActive(MiddleClickFriend.class)) {
            this.warning("You have Middle Click Friend enabled, overriding.");
        }
