...
public class UDPFlood extends Module {
    ...
    public UDPFlood() {
        super(RandomAddon.CATEGORYC, "UDP Flood", "CRYSTAL || Floods the server with UDP requests+.");
            ...
            if (!mc.isInSingleplayer()) {
                if (mc.getCurrentServerEntry() != null) {
                    ...
                    try {
                        ...
                        MeteorClient.LOG.error("Error in obtaining server IP: " + e.getMessage());
                        error("Error in obtaining server IP. Please check your connection, toggling.");
                        toggle();
                    }
                } else {
                    MeteorClient.LOG.error("Error in UDPFlood, the server is null.");
    ...
    private void floodServer(String serverIp, int serverPort) {
        ...
        try (DatagramSocket socket = new DatagramSocket()) {
            ...
            if (!isValidIpAddress(serverIp)) {
                MeteorClient.LOG.error("Invalid server IP: " + serverIp);
            ...
            MeteorClient.LOG.error("Exception in: " + e);
