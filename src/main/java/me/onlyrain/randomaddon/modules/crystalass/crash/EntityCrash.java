...
public class EntityCrash extends Module {
    ...
    public EntityCrash() {
        super(RandomAddon.CATEGORYC, "Entity Crash", "CRYSTAL || Tries to crash the server you are on by abusing entity packets.");
                                ...
                                while (true) {
                                    if (i < amount.get()) {
                                        try {
                                            ...
                                            MeteorClient.LOG.error("NullPointerException for EntityCrash Position: ", NPE);
                                        }
                            ...
                            while (true) {
                                if (i < amount.get()) {
                                    ...
                                    try {
                                        ...
                                        MeteorClient.LOG.error("NullPointerException for EntityCrash Movement: ", NPE);
                                    }
                                    i++;
                                } else {
                                    break;
