...
public class PingSpoofer extends Module {
    ...
    public PingSpoofer() {
        super(RandomAddon.CATEGORYC, "Ping Spoofer", "CRYSTAL || Spoof your ping.");
    ...
    public void onDeactivate() {
        try {
            ...
            MeteorClient.LOG.error("NullPointerException for PingSpoof onDeactivate: ", NPE);
        }
    ...
    private void onReceivePacket(PacketEvent.Receive event) {
        try {
            ...
            MeteorClient.LOG.error("NullPointerException for PingSpoof onReceivePacket: ", NPE);
        }
    ...
    private void onSendPacket(PacketEvent.Send event) {
        try {
            ...
            MeteorClient.LOG.error("NullPointerException for PingSpoof onSendPacket: ", NPE);
        }
