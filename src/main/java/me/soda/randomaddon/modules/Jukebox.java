...
public class Jukebox extends Module {
    ...
    public Jukebox() {
        super(Random.CATEGORY, "jukebox", "Customize ingame sound.");
    }
    ...
    public WWidget getWidget(GuiTheme theme) {
        ...
        for (var disc : Registries.ITEM.stream().filter(o -> o instanceof MusicDiscItem).map(MusicDiscItem.class::cast).toList()) {
