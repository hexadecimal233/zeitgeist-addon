...
public class MassPayout extends Module {
    ...
    public MassPayout() {
        super(Zeitgeist.CATEGORYC, "Mass Payout", "A module to use the /pay command on some servers. Made for nuking and mass paying all players.");
        ...
        delay = sgGeneral.add(new IntSetting.Builder()
            .name("Delay")
            .description("The delay time in ms before paying each time.")
            .defaultValue(5000)
            .min(0)
            .max(300000)
            .sliderMin(0)
