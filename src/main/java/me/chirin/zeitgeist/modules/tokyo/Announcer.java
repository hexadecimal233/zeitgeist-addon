package me.chirin.zeitgeist.modules.tokyo;

import me.chirin.zeitgeist.Zeitgeist;
import me.chirin.zeitgeist.mixininterfaces.IStarscript;
import me.chirin.zeitgeist.utils.MathUtils;
...
public class Announcer extends Module {
    ...
    public Announcer() {
        super(Zeitgeist.CATEGORY, "announcer", "Announces specified actions into chat.");
    }
    ...
    private void calculateDelay() {
        if (ChatManager.INSTANCE.isActive()) {
            ...
            if (delay <= 0) {
                error("Minimum Announcer delay is lower than ChatManager's chat delay!");
                if (isActive()) {
